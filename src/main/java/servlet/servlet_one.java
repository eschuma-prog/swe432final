...
@WebServlet(name = "AdditionalServlet", urlPatterns = {"/servlet_one"})
public class servlet_one extends HttpServlet
{
          ...
          throws ServletException, IOException
   {
		...
		out.println("<h1><b>SWE 432 A7 ~ <i><font size=5>Eric Schumacher, Arian Filipour, & Daniel Sinani</font></i></h1></b>");
		...
		out.println("<form method=\"post\" action=\"https://dsinaniwebapps.herokuapp.com/servlet_two\" id=\"fm\">");
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/servlet_two");
